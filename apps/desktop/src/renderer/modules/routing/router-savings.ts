 ...
 * (`RoutingDecisionRow.baselinePrices`, decisions doc SS13 item 10) -- not
 * an approximation against today's retail price for each row's own actual
 * model.
 */
 ...
 * when one is active, falling back to a plugin-agnostic generic default
 * otherwise (runlog 2026-09-0X) -- see `activeAutoRouterSavingsBaselineModel`.
 */
