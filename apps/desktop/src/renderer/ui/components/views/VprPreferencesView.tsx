...
const LEVANTO_ROUTER_DESCRIPTION = 'Levanto Model Router picks the best model and seller for every message in '
  + 'real time, balancing cost against quality to your own preference — so you get consistently better answers '
  + 'for less, without ever switching models by hand. In benchmarks, it beats routing through OpenRouter on both '
  + 'cost and quality.';
